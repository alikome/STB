...
export default function Mint() {
  ...
  const [isGaSale, setIsGaSale] = useState(false)
  ...
  useEffect(() => {
    const init = async () => {
      ...
      const isGaSale = await isGaSaleState()
      setIsGaSale(isGaSale)

      setMaxMintAmount(
        config.giveawayMaxMintAmount
      )
    }
  ...
  const giveawayMintHandler = async () => {
    setIsMinting(true)

    const { success, status } = await giveawayMint(mintAmount)
            ...
            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
              ...
              <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                <div className="font-coiny flex items-center justify-between w-full">
                  <button
                    className="cursor-not-allowed w-14 h-10 md:w-16 md:h-12 flex items-center justify-center text-brand-background hover:shadow-lg bg-gray-400 font-bold rounded-md"
                    disabled
                  >
                    <svg //plus
                  ...
                  <button
                    className="bg-gray-400 cursor-not-allowed w-14 h-10 md:w-16 md:h-12 flex items-center justify-center text-brand-background hover:shadow-lg font-bold rounded-md"
                    disabled
                  >
                    <svg //minus
                      xmlns="http://www.w3.org/2000/svg"
